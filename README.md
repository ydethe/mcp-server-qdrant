...
| `TOOL_STORE_DESCRIPTION` | Custom description for the store tool                               | See default in [`settings.py`](src/mcp_server_qdrant_im/settings.py) |
| `TOOL_FIND_DESCRIPTION`  | Custom description for the find tool                                | See default in [`settings.py`](src/mcp_server_qdrant_im/settings.py) |
...
```shell
COLLECTION_NAME=mcp-dev fastmcp dev src/mcp_server_qdrant_im/server.py
```
...
fastmcp dev src/mcp_server_qdrant_im/server.py
```
